        ...
        <div class="flex-none bg-slate-50/50  px-6 py-6 sm:px-8 sm:py-8 border-t border-slate-100 <?= $roundedEnabled ? 'rounded-b-2xl' : '' ?>">
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <?php if (isset($consent_manager->texts['button_select_none'])): ?>
                    <button tabindex="0" id="consent_manager-accept-none" class="consent_manager-accept-none consent_manager-close flex-1 px-4 py-3.5 bg-blue-600 border border-blue-600 text-white text-[11px] font-bold uppercase tracking-widest hover:bg-blue-700 transition-all shadow-sm active:scale-[0.98] <?= $buttonRoundedClass ?>"><?= $consent_manager->texts['button_select_none'] ?></button>
                <?php endif; ?>
